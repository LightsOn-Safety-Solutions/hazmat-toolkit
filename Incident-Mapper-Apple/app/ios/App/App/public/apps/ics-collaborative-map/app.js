(() => {
  ...
  const ICS207_SLOT_META = {
    ...
    BRANCHES: { label: "Branches", roleLabel: "Branches", x: 50, y: 336, w: 100, h: 36 },
    AIR_OPS_BRANCH: { label: "Air Ops Branch", roleLabel: "Air Ops Branch", x: 168, y: 336, w: 92, h: 36 },
    ...
    RESOURCES: { label: "Resources Unit Ldr.", roleLabel: "Resources Unit Ldr.", x: 212, y: 286, w: 100, h: 38 },
    DEMOB: { label: "Demobilization Unit Ldr.", roleLabel: "Demobilization Unit Ldr.", x: 322, y: 286, w: 100, h: 38 },
    SITUATION: { label: "Situation Unit Ldr.", roleLabel: "Situation Unit Ldr.", x: 212, y: 336, w: 100, h: 38 },
    DOCUMENTATION: { label: "Documentation Unit Ldr.", roleLabel: "Documentation Unit Ldr.", x: 322, y: 336, w: 100, h: 38 },
